...
function Historial(ID) {
    ...
    var botonLibroEstrella = document.getElementById('botonLibroEstrella');

    // Agrega un evento de clic al botón
    botonLibroEstrella.addEventListener('click', function() {
        // Redirige a la URL deseada al hacer clic en el botón
        window.location.href = 'https://leanpub.com/php-negocios-web-intro';
    });
