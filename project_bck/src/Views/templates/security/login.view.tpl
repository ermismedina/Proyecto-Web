...
<div class="ContenedorLogin">
  ...
  <div class="ContenedorFormulario" class="ContenedorImagen">
    <form method="post" action="index.php?page=sec_login{{if redirto}}&redirto={{redirto}}{{endif redirto}}">
      <div class="Box">
       
        <p>La pasión por el cine, ¡vívela aquí!</p>
    ...
    <p style="color: black;">Eres Nuevo Usuario? <a style="color: #3496db; text-decoration:underline;" id='Crear'
