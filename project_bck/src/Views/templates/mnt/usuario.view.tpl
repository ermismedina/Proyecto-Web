        ...
        <fieldset>            
            <button class="btnCancelar" name="btnCancelar" id="btnCancelar">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M7.354 12.354a.5.5 0 0 1 0-.708L3.707 8l3.647-3.646a.5.5 0 0 1 .708.708L5.707 7.5H13a.5.5 0 0 1 0 1H5.707l2.354 2.354a.5.5 0 0 1-.708.708z"/>
                </svg>
                  Regresar 
            </button>
        </fieldset>
