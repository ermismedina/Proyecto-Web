<section class="ContenedorCompras">
    <div class="Caja1">    
        {{ifnot Cantidad}}
            <h4 style="color: black; margin-left: 5%;">No ha seleccionado ninguna pelicula</h4>
        {{endifnot Cantidad}}    
    </div>
    <div class="Caja2">
...
<section class="Detalle">
    ...
    <div class="ContenedorFormulario" style="margin: auto;">
        <form method="post" action="index.php?page=sec_login{{if redirto}}&redirto={{redirto}}{{endif redirto}}">
            <div class="Box">
                <h1>FILMOTECA</h1>
                <p>Una buena pelicula es más que una piedra preciosa</p>
        ...
        <p style="color: black;">Nuevo Usuario? <a style="color: #3496db; text-decoration:underline;" id='Crear'
