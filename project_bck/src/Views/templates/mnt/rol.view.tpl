...
<form action="index.php?page=mnt_rol" method="post">
    ...
    <div class="Box1">
        ...
        <div class="Box1">
            <fieldset style="left: 0%; margin: 25% 5%">
                <div class="Botones">
                    <button class="btnCancelar" name="btnCancelar" id="btnCancelar" style="width: 250px; height: 100px; background-color: red; color: white; font-size: 20px; margin-right: 10px;">
                        Cancelar
                    </button>
                    <button class="btnEnviar" type="submit" name="btnEnviar" style="width: 250px; height: 100px; background-color: green; color: white; font-size: 20px;">
                        {{btnEnviarText}}
                    </button>
                </div>
            </fieldset>
