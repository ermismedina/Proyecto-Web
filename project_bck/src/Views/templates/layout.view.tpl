...
<body>
  <div class="Header">
    <div class="Logo">
      ...
      <ul class="Menu">
        <li><a href="index.php?page=mnt-index"><svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M21 11.016v-5.016h-18v5.016l2.484-2.484 1.5 1.5 5.016-5.016 6.516 6.516 1.5-1.5-5.016-5.016zM6 18v-2.016h12v2.016h-12z"/></svg></a></li>
        <li><a href="index.php?page=sec_login"><svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M18 2.016h-12c-1.078 0-1.969 0.938-1.969 2.016v6h2.016v-2.016h9.984v12h-9.984v-2.016h-2.016v6c0 1.078 0.891 1.969 1.969 1.969h12c1.125 0 2.016-0.891 2.016-1.969v-12.984c0-1.078-0.891-2.016-2.016-2.016zM12 18.984l3.984-3.984h-3v-6h-1.969v6h-3z"/></svg></a></li>
        <li><a href="index.php?page=sec_register"><svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 15c-2.203 0-3.984-1.781-3.984-3.984s1.781-4.031 3.984-4.031s3.984 1.828 3.984 4.031s-1.781 3.984-3.984 3.984zM12 6c-2.203 0-4.031 1.781-4.031 3.984c0 1.781 1.5 3.516 3.234 3.938c0.422-0.047 0.797-0.047 1.172-0.141c0.703-0.156 1.313-0.422 1.828-0.844c0.234-0.188 0.469-0.375 0.656-0.609c0.047-0.047 0.141-0.141 0.234-0.234c0.234-0.281 0.422-0.609 0.563-0.984c0.188-0.469 0.281-0.984 0.281-1.5c0-2.203-1.828-3.984-4.031-3.984zM12 18c3.328 0 6 2.672 6 6h-12c0-3.328 2.672-6 6-6zM12 9c-2.672 0-4.969-1.828-5.578-4.313c1.828 0.328 3.234 1.922 3.234 3.984c0 1.172-0.469 2.25-1.219 3.047c0.141 0.141 0.328 0.281 0.516 0.422c0.844 0.656 1.828 1.031 2.828 1.031c0.563 0 1.031-0.141 1.547-0.328c0.469-0.141 0.891-0.328 1.266-0.609c0.094-0.047 0.188-0.141 0.281-0.234c0.141-0.141 0.328-0.328 0.469-0.516c0.328-0.422 0.563-0.938 0.563-1.547c0-1.266-1.031-2.25-2.297-2.25z"/></svg></a></li>
      </ul>
    </div>
  </div>
